      ...
      <HorizontalBox>
        <Suspense fallback={<Page sidebar><Loading /></Page>}>
          <Switch>
            ...
            <Route exact path="/projects" component={this._renderLazyComponent(Projects)} />
            <Route exact path="/reports" component={this._renderLazyComponent(Reports)} />
            <Route exact path="/roles" component={this._renderLazyComponent(Roles)} />
